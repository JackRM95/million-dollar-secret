...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Load shared missions from separate Firestore key
    ...
    const unsub = subscribeShared(incoming => {
      ...
      // Merge in shared missions if we have them
      loadMissions().then(sharedMissions => {
        if (sharedMissions) g.missions = sharedMissions;
        setGame(prev => {
          if (prev === null) {
