...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsub = subscribeShared(incoming => {
      let g = migrateGame(incoming || defaultGame());

      // Auto-expire missions from previous days
      ...
      if (firstLoad.current) {
        ...
        // Determine initial mode on first snapshot only
    ...
    // Seed Firestore if brand new game
    loadShared().then(g => {
      if (!g) {
